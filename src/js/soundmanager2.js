...
function SoundManager(smURL, smID) {
  ...
  this.hasHTML5 = (function() {
    try {
      ...
      return (Audio !== _undefined && (isOpera ? new Audio(null) : new Audio()).canPlayType !== _undefined);
    } catch(e) {
      return false;
    }
  }());
    ...
    this._setup_html5 = function(options) {
      ...
      if (a) {
        ...
        if (instanceOptions.autoLoad || instanceOptions.autoPlay) {
          ...
          s._a = (isOpera ? new Audio(null) : new Audio());
  ...
  testHTML5 = function() {
    ...
    var a = (Audio !== _undefined ? (isOpera ? new Audio(null) : new Audio()) : null),
